...
\usepackage{chngcntr} % Para mudar estilos de numeração
% Agrupar numeração de figuras por capítulo
...
% ---
\titulo{Eletrônica Embarcada para Múltiplos Robôs Autônomos}
\autor{Renan Pícoli de Souza}
...
\instituicao{%
  ...
  \par
  Seção de Engenharia de Sistemas/SE8
  %  \par
  %  Graduação em Engenharia de Computação
}
\tipotrabalho{Relatório Parcial 1}
...
\hypersetup{%
  ...
  pdfkeywords={ime}{robocup}{analise}{discretização}{otimização},
...
% @PICOLI comentou a linha abaixo:
...
% @PÍCOLI: comentei a ficha catalográfica
...
% @PÍCOLI: comentei a folha  de aprovação
%\convidadoum{Bruno Eduardo Madeira}{M.Sc., do IME}
%\convidadodois{Ricardo Choren Noya}{D.Sc., do IME}
%\convidadotres{Julio Cesar Duarte}{D.Sc., do IME}
...
% @PÍCOLI: comentei o resumo (e o abstract)
%\input{doc/resumo}
...
\input{doc/overview}
\input{doc/com_spi}
\input{doc/necessidade_abstr_hw}
\input{doc/bibl_cpp}
\input{doc/design_placas}
\input{doc/larc_2016}
\input{doc/const_pid}
\input{doc/kalman}
\input{doc/robocup_2017}

%\input{doc/modelagem}
%\input{doc/arquitetura}
%\input{doc/resultados}
%\input{doc/cons_finais}
...
\bibliographystyle{ieeetr} % was plain
...
% Inicia os apêndices
% ---
% @PÍCOLI: desabilitei (comentei) os apêndices
%\begin{apendicesenv}
%
